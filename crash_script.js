...
var getboundary = function (map) { // Add Portland municipal boundary
    url = "https://nominatim.openstreetmap.org/search.php?city=portland&state=maine&polygon_geojson=1&format=jsonv2"
